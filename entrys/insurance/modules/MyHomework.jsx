...
import CourseHomework from '../modules/CourseHomework.jsx';
var ProxyQ = require('../../../components/proxy/ProxyQ');
var SyncStore = require('../../../components/flux/stores/SyncStore');

var MyHomework=React.createClass({
    ...
    render:function() {
            ...
            data.map(function (item, i) {
                trs.push(
                    ...
                    <tr>
                        ...
                        <td>
                            <span style={{textAlign:'center',fontSize:'14px',marginRight:'5px',textDecoration:'underline',cursor:'pointer',color:'#054c61'}} onClick={ref.tabChange.bind(this,'CourseHomework',item.taskId)}>
                                  查看作业
                            </span>
                        </td>
                    </tr>
        ...
        if(this.state.current =='CourseHomework'){
