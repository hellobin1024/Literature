...
// encapsulated variables
    ...
    Highcharts.numberFormat = function (number, decimals, decimalPoint, thousandsSep) {
        ...
        // A string containing the positive integer components of the number
        ...
        // Add the decimal point and the decimal components
        if (decimals) {
            // Get the decimal components, and add power to avoid rounding errors with float numbers (#4573)
